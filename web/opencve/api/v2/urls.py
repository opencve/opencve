...
router.register(r"activity", ActivityViewSet, basename="v2-activity")
router.register(r"statistics", StatisticsViewSet, basename="v2-statistics")
...
projects_router.register(
    r"subscriptions", ProjectSubscriptionViewSet, basename="v2-project-subscription"
)
projects_router.register(
...
urlpatterns = (
    ...
    + [
        path(
            "weaknesses/<str:weakness_cwe_id>/cves",
        ...
        path(
            "organizations/<str:organization_name>/projects/<str:project_name>/cves/<str:cve_id>/comments",
            ProjectCveCommentViewSet.as_view({"get": "list", "post": "create"}),
            name="v2-organization-project-cve-comments",
        ),
        path(
            "organizations/<str:organization_name>/projects/<str:project_name>/cves/<str:cve_id>/comments/<uuid:pk>",
            ProjectCveCommentViewSet.as_view(
                {"patch": "partial_update", "delete": "destroy"}
            ),
            name="v2-organization-project-cve-comment-detail",
        ),
        path(
            "organizations/<str:organization_name>/projects/<str:project_name>/notifications/<str:notification_name>/test",
            NotificationTestView.as_view(),
            name="v2-organization-project-notification-test",
        ),
    ]
)
