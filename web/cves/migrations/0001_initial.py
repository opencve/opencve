    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['vendors'], name='ix_cves_vendors'), django.contrib.postgres.indexes.GinIndex(fields=['metrics'], name='ix_cves_metrics'), django.contrib.postgres.indexes.GinIndex(fields=['weaknesses'], name='ix_cves_weaknesses'), django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.indexes.OpClass(django.db.models.functions.text.Upper('title'), name='gin_trgm_ops'), name='ix_cves_title'), django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.indexes.OpClass(django.db.models.functions.text.Upper('description'), name='gin_trgm_ops'), name='ix_cves_description'), django.contrib.postgres.indexes.GinIndex(django.contrib.postgres.indexes.OpClass(django.db.models.functions.text.Upper('cve_id'), name='gin_trgm_ops'), name='ix_cves_cve_id')],
            },
        ),
