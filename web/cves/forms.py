...
class SearchForm(forms.Form):
    q = forms.CharField(
        required=False,
        help_text=mark_safe(
            "Use the syntax <code>description:python AND cvssV3_1>=8</code>. "
            'For more details, check the <a href="https://docs.opencve.io/guides/docs/cves-search-syntax/">documentation</a>.'
        ),
    )
