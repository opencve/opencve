...
REDIS_PREFIX_REPORT_HOURLY_CONTENT_ITEMS = "report_hourly_content_items"
REDIS_PREFIX_REPORT_DUE_WORK_ITEMS = "report_due_work_items"
REDIS_PREFIX_AUTOMATION_ACTION_QUEUE_ALERT = "automation_action_queue_alert"
REDIS_PREFIX_AUTOMATION_ACTION_QUEUE_REPORT_DUE = "automation_action_queue_report_due"
...
def automation_action_queue_prefix(queue_name: str) -> str:
    ...
    if queue_name == "alert":
        return REDIS_PREFIX_AUTOMATION_ACTION_QUEUE_ALERT
    if queue_name == "report_due":
        return REDIS_PREFIX_AUTOMATION_ACTION_QUEUE_REPORT_DUE
    raise ValueError(
        f"Unknown automation action queue_name={queue_name!r}; "
        f"expected 'alert' or 'report_due'"
    )
